...
public class RecipesFuser
{
	...
	private RecipesFuser()
	{
		...
		addRecipe(new ShapedFuserRecipe(ItemsLT.ELEMENTAL_AXE, "ff", "ft", " w", 'f', EnumMultiMaterialType.AQUEOUS_CRYSTAL, 't', ItemsLT.THAUMIUM_AXE, 'w', EnumMultiMaterialType.ENCHANTED_WOOD).setVisUsage(10.5F, 0).setResearch(ResearchesLT.ELEMENTAL_AXE));
