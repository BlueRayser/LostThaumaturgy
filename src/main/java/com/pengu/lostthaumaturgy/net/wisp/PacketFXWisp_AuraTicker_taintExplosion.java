...
public class PacketFXWisp_AuraTicker_taintExplosion implements IPacket, IPacketListener<PacketFXWisp_AuraTicker_taintExplosion, IPacket>
{
	double x, y, z, tx, ty, tz;
	float partialTicks;
	int type;
	
	public PacketFXWisp_AuraTicker_taintExplosion(double x, double y, double z, double tx, double ty, double tz, float partialTicks, int type)
	{
		this.x = x;
		this.y = y;
		this.z = z;
