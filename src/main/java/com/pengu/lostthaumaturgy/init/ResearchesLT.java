...
import com.pengu.lostthaumaturgy.custom.research.Research.PrimordialResearch;
...
public class ResearchesLT
{
	public static final Research //
	        ...
	        CRYSTALLINE_BELL = new Research(LTInfo.MOD_ID + ":crystalline_bell", 75, Research.CATEGORY_BASICS).setColor(0xAFFFFF).setIcon(new ItemStack(ItemsLT.CRYSTALLINE_BELL)), //
	        ...
	        ELEMENTAL_AXE = new Research(LTInfo.MOD_ID + ":elemental_axe", 40, Research.CATEGORY_LOST_KNOWLEDGE).setIcon(new ItemStack(ItemsLT.ELEMENTAL_AXE)), //
	        ELEMENTAL_SHOVEL = new Research(LTInfo.MOD_ID + ":elemental_shovel", 40, Research.CATEGORY_LOST_KNOWLEDGE).setIcon(new ItemStack(ItemsLT.ELEMENTAL_SHOVEL)), //
	        ELEMENTAL_SWORD = new Research(LTInfo.MOD_ID + ":elemental_sword", 40, Research.CATEGORY_LOST_KNOWLEDGE).setIcon(new ItemStack(ItemsLT.ELEMENTAL_SWORD)), //
	        QUICKSILVER_CORE = new Research(LTInfo.MOD_ID + ":quicksilver_core", 35, Research.CATEGORY_BASICS).setColor(0xBEBDEA).setIcon(new ItemStack(ItemsLT.QUICKSILVER_CORE)), //
	        VIS_PURIFIER = new Research(LTInfo.MOD_ID + ":vis_purifier", 35, Research.CATEGORY_TAINTED).setIcon(new ItemStack(BlocksLT.VIS_PURIFIER)), //
	        ...
	        PRIMORDIAL_CRYSTAL = new PrimordialResearch(LTInfo.MOD_ID + ":primordial_crystal", 95, Research.CATEGORY_PRIMORDIAL).setIcon(EnumMultiMaterialType.PRIMORDIAL_CRYSTAL.stack());
	...
	public static void registerResearches()
	{
		...
		t.setCategoryItemIcon(EnumMultiMaterialType.PRIMORDIAL_CRYSTAL.stack(), Research.CATEGORY_PRIMORDIAL);
