...
public class ResearchesLT
{
	public static void registerResearches()
	{
		...
		new ResearchItem("quicksilver_core", "thaumaturgy", 3, 2, 35, new ItemStack(ItemsLT.QUICKSILVER_CORE)).setColor(0xBEBDEA).setParents("singularity").setPages(new ResearchPage("lt.research_desc.quicksilver_core"), new ResearchPage(null, new ItemStack(ItemsLT.QUICKSILVER_CORE))).registerResearch();
