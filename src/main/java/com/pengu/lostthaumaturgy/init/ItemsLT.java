...
import com.pengu.lostthaumaturgy.core.items.DefaultSealSymbol;
import com.pengu.lostthaumaturgy.core.items.ItemAuraDetector;
import com.pengu.lostthaumaturgy.core.items.ItemCrystallineBell;
import com.pengu.lostthaumaturgy.core.items.ItemCustomPotion;
import com.pengu.lostthaumaturgy.core.items.ItemMultiMaterial;
import com.pengu.lostthaumaturgy.core.items.ItemResearch;
import com.pengu.lostthaumaturgy.core.items.ItemSingularity;
import com.pengu.lostthaumaturgy.core.items.ItemThaumonomicon;
import com.pengu.lostthaumaturgy.core.items.ItemUpgrade;
import com.pengu.lostthaumaturgy.core.items.ItemVoidCompass;
import com.pengu.lostthaumaturgy.core.items.ItemWand;
import com.pengu.lostthaumaturgy.core.items.ItemWandOfItemFreeze;
import com.pengu.lostthaumaturgy.core.items.ItemWandReversal;
import com.pengu.lostthaumaturgy.core.items.armor.ItemThaumiumArmor;
import com.pengu.lostthaumaturgy.core.items.armor.ItemVoidArmor;
import com.pengu.lostthaumaturgy.core.items.armor.boots.ItemBootsStriding;
...
import com.pengu.lostthaumaturgy.core.items.tools.axe.ItemAxeThaumium;
import com.pengu.lostthaumaturgy.core.items.tools.hoe.ItemHoeElemental;
import com.pengu.lostthaumaturgy.core.items.tools.hoe.ItemHoeThaumium;
import com.pengu.lostthaumaturgy.core.items.tools.pick.ItemPickaxeElemental;
import com.pengu.lostthaumaturgy.core.items.tools.pick.ItemPickaxeThaumium;
import com.pengu.lostthaumaturgy.core.items.tools.shovel.ItemShovelElemental;
import com.pengu.lostthaumaturgy.core.items.tools.shovel.ItemShovelThaumium;
import com.pengu.lostthaumaturgy.core.items.tools.swords.ItemSwordElemental;
import com.pengu.lostthaumaturgy.core.items.tools.swords.ItemSwordThaumium;
...
public class ItemsLT
{
	...
	public static final ItemSealSymbol //
	        ...
	        RUNICESSENCE_PRIMORDIAL = new DefaultSealSymbol("runic_essence_primordial", 7, -1);
}