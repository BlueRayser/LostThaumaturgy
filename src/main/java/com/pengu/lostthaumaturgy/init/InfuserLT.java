...
public class InfuserLT
{
	public static void registerInfuser()
	{
		...
		RecipesInfuser.addInfusing(new ItemStack(BlocksLT.CONDUIT_SILVERWOOD, 3), 27, RecipesInfuser.createPredicateFromResearches(ResearchesLT.CONDUIT_SILVERWOOD), EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(), new ItemStack(BlocksLT.CONDUIT), EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(), new ItemStack(BlocksLT.CONDUIT), EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(), new ItemStack(BlocksLT.CONDUIT), EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack());
		RecipesInfuser.addInfusing(new ItemStack(BlocksLT.CONDUIT_SILVERWOOD, 2), 18, RecipesInfuser.createPredicateFromResearches(ResearchesLT.CONDUIT_SILVERWOOD), EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(), new ItemStack(BlocksLT.CONDUIT), EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(), new ItemStack(BlocksLT.CONDUIT), EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack());
		RecipesInfuser.addInfusing(new ItemStack(BlocksLT.CONDUIT_SILVERWOOD, 1), 9, RecipesInfuser.createPredicateFromResearches(ResearchesLT.CONDUIT_SILVERWOOD), EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(), new ItemStack(BlocksLT.CONDUIT), EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack());
	}
