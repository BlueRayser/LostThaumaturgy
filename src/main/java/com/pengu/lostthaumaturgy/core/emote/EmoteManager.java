...
public class EmoteManager
{
	...
	public static ResourceLocation getEmoteLocation(String id)
	{
		...
		TEXTURES.put(tx, new ResourceLocation(rl.getResourceDomain().equals("minecraft") ? Info.MOD_ID : rl.getResourceDomain(), "textures/particle/emote/" + rl.getResourcePath() + ".png"));
