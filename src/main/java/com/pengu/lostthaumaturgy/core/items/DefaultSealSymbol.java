...
public class DefaultSealSymbol extends ItemSealSymbol
{
	...
	public DefaultSealSymbol(String name, int tex, int tex3color)
	{
		...
		this.tex1 = new ResourceLocation(Info.MOD_ID, "textures/misc/seals/s_0_" + tex + ".png");
		this.tex2 = new ResourceLocation(Info.MOD_ID, "textures/misc/seals/s_1_" + tex + ".png");
		this.tex3 = new ResourceLocation(Info.MOD_ID, "textures/misc/seals/s_2_x.png");
