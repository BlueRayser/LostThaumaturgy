...
public class TESRCrucibleThaumium extends TESR<TileCrucibleThaumium>
{
	...
	public void renderTileEntityAt(TileCrucibleThaumium te, double x, double y, double z, float partialTicks, ResourceLocation destroyStage, float alpha)
	{
		...
		try
		{
			...
			TextureAtlasSprite side_disconnected = ClientProxy.getSprite(Info.MOD_ID + ":blocks/crucibles/thaumium/crucible_side_disconnected_" + sub);
			TextureAtlasSprite bottom = ClientProxy.getSprite(Info.MOD_ID + ":blocks/crucibles/thaumium/crucible_bottom");
			TextureAtlasSprite top = ClientProxy.getSprite(Info.MOD_ID + ":blocks/crucibles/thaumium/crucible_top");
			...
			TextureAtlasSprite base = ClientProxy.getSprite(Info.MOD_ID + ":blocks/crucibles/thaumium/crucible_inner");
			TextureAtlasSprite side_connected = ClientProxy.getSprite(Info.MOD_ID + ":blocks/crucibles/thaumium/crucible_side_connected_" + sub);
	...
	public void renderFromNBT(NBTTagCompound nbt, double x, double y, double z, float partialTicks, ResourceLocation destroyStage)
	{
		...
		TextureAtlasSprite side_disconnected = ClientProxy.getSprite(Info.MOD_ID + ":blocks/crucibles/thaumium/crucible_side_disconnected_" + ((pureVis + taintedVis) >= maxVis * .9F ? "on" : "off"));
		TextureAtlasSprite bottom = ClientProxy.getSprite(Info.MOD_ID + ":blocks/crucibles/thaumium/crucible_bottom");
		TextureAtlasSprite top = ClientProxy.getSprite(Info.MOD_ID + ":blocks/crucibles/thaumium/crucible_top");
		TextureAtlasSprite spill = ClientProxy.getSprite(Info.MOD_ID + ":blocks/crucible_spill");
		TextureAtlasSprite vis = ClientProxy.getSprite(Info.MOD_ID + ":blocks/fluid_vis");
