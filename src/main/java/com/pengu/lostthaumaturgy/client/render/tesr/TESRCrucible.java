...
public class TESRCrucible extends TESR<TileCrucible>
{
	...
	public void renderTileEntityAt(TileCrucible te, double x, double y, double z, float partialTicks, ResourceLocation destroyStage)
	{
		...
		try
		{
			...
			TextureAtlasSprite side_disconnected = ClientProxy.getSprite(LTInfo.MOD_ID + ":blocks/crucible_side_disconnected");
			TextureAtlasSprite bottom = ClientProxy.getSprite(LTInfo.MOD_ID + ":blocks/crucible_bottom");
			TextureAtlasSprite top = ClientProxy.getSprite(LTInfo.MOD_ID + ":blocks/crucible_top");
			...
			TextureAtlasSprite base = ClientProxy.getSprite(LTInfo.MOD_ID + ":blocks/crucible_inner");
			TextureAtlasSprite side_connected = ClientProxy.getSprite(LTInfo.MOD_ID + ":blocks/crucible_side_connected");
