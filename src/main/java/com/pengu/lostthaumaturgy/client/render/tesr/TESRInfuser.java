...
public class TESRInfuser extends TESR<TileInfuser>
{
	...
	protected ResourceLocation disk = new ResourceLocation(Info.MOD_ID, "textures/misc/infuser_symbol.png");
	...
	private void renderModel(TileInfuser tile, double x, double y, double z, double angle, boolean active)
	{
		...
		TextureAtlasSprite side_disconnected = ClientProxy.getSprite(Info.MOD_ID + ":blocks/infuser_side_disconnected");
		TextureAtlasSprite bottom = ClientProxy.getSprite(Info.MOD_ID + ":blocks/infuser_bottom");
		TextureAtlasSprite top = ClientProxy.getSprite(Info.MOD_ID + ":blocks/infuser_top");
		TextureAtlasSprite side_connected = ClientProxy.getSprite(Info.MOD_ID + ":blocks/infuser_side_connected");
